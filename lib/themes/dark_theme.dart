...
ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      displayLarge: TextStyle(fontSize: 29,color: Colors.white,fontWeight: FontWeight.w600),
      displayMedium: TextStyle(fontSize: 25, color: Colors.white54,fontWeight: FontWeight.w600),
      displaySmall: TextStyle(fontSize: 22, color: Colors.white30,fontWeight: FontWeight.w500),
      bodyLarge: TextStyle(fontSize: 17,color: Colors.white,fontWeight: FontWeight.w500),
