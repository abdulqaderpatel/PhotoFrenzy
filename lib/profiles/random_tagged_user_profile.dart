...
class RandomTaggedUserProfile extends StatefulWidget {
  ...
  const RandomTaggedUserProfile({super.key, required this.username});

  @override
  RandomTaggedUserProfileState createState() =>
      RandomTaggedUserProfileState();
}

class RandomTaggedUserProfileState extends State<RandomTaggedUserProfile>
  ...
  void getPosts() async {
    ...
    await FirebaseTable()
        .postsTable
        .where("creator_username", isEqualTo: widget.username)
        .count()
        .get()
        .then(
    ...
    CollectionReference collectionRef = FirebaseTable().usersTable;


    QuerySnapshot querySnapshot = await collectionRef.where(
        "username", isEqualTo: widget.username).get();
                ...
                child: Column(
                  children: [
                    ...
                    SvgPicture.asset(
                        ...
                        height: Get.height * 0.2),
                    SizedBox(height: Get.height * 0.015,),
                    Text("No image posts", style: Theme
                        .of(context)
                        .textTheme
                        .displayLarge,)
                  ],
        ...
        child: Container(margin: const EdgeInsets.all(15),
          child: Column(mainAxisAlignment: MainAxisAlignment.center,
            ...
            children: [
              ...
              SvgPicture.asset(
                  "assets/images/nonexistent_user.svg",
                  height: Get.height * 0.3),
              SizedBox(height: Get.height * 0.05,),
              Text("The mentioned user @${widget.username} does not exist",
                style: Theme
                    .of(context)
                    .textTheme
                    .displayLarge,)
