...
class RandomPostCommentsScreen extends StatefulWidget {
  final String postId;
  final String description;
  final String imageurl;

  const RandomPostCommentsScreen(
  ...
  @override
  State<RandomPostCommentsScreen> createState() => _RandomPostCommentsScreenState();
}

class _RandomPostCommentsScreenState extends State<RandomPostCommentsScreen> {
